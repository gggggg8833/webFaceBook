...
<h2 id="_6-html5的特性有哪些" tabindex="-1"><a class="header-anchor" href="#_6-html5的特性有哪些"><span>6.HTML5的特性有哪些？</span></a></h2>
<ol>
<li>
...
<li>
<p>webStorage：</p>
<p>分为localStorage和sessionStorage
localStorage用于永久保存整个网站的数据，保存的数据没有过期时间，除非手